...
var GitLoader = /** @class */ (function () {
    ...
    GitLoader.prototype._load = function (pointer, options) {
        return tslib.__awaiter(this, void 0, void 0, function () {
    ...
    GitLoader.prototype.load = function (pointer, options) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var result, path, finalResult, resolvedPaths, _a, _b, _c, _d;
            var _this = this;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                        ...
                        return [4 /*yield*/, Promise.all(resolvedPaths.map(function (path) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                ...
                                return tslib.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 1:
                                            results = _a.sent();
                                            finalResult.push.apply(finalResult, tslib.__spreadArray([], tslib.__read(results)));
                                            return [2 /*return*/];
                                    }
                                });
                            }); }))];
                    ...
                    case 4:
                        ...
                        _c = [finalResult];
                        _d = [[]];
                        return [4 /*yield*/, this._load(pointer, options)];
                    case 5:
    ...
    GitLoader.prototype._loadSync = function (pointer, options) {
    ...
    GitLoader.prototype.loadSync = function (pointer, options) {
        ...
        if (isGlob(path)) {
            ...
            try {
                for (var resolvedPaths_1 = tslib.__values(resolvedPaths), resolvedPaths_1_1 = resolvedPaths_1.next(); !resolvedPaths_1_1.done; resolvedPaths_1_1 = resolvedPaths_1.next()) {
                    ...
                    if (this.canLoadSync(path_3)) {
                        finalResult_1.push.apply(finalResult_1, tslib.__spreadArray([], tslib.__read(this.loadSync(path_3, options))));
                    }
                }
            }
            ...
            finalResult.push.apply(finalResult, tslib.__spreadArray([], tslib.__read(this._loadSync(pointer, options))));
        }
        return finalResult;
    };
    return GitLoader;
