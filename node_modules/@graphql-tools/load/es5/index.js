...
function loadTypedefsSync(pointerOrPointers, options) {
    ...
    options.ignore = utils.asArray(options.ignore || []);
    (_a = options.ignore).push.apply(_a, tslib.__spreadArray([], tslib.__read(ignore)));
    applyDefaultOptions(options);
        ...
        return tslib.__generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    mergeSchemasOptions = tslib.__assign({ schemas: schemas, typeDefs: typeDefs }, options);
...
function loadSchemaSync(schemaPointers, options) {
    ...
    var mergeSchemasOptions = tslib.__assign({ schemas: schemas, typeDefs: typeDefs }, options);
